...
const ShopHome3 = () => {
  ...
  return (
    <div className='bg-[#9f9279] bg-cover bg-center bg-[url("https://res.cloudinary.com/decks92gf/image/upload/v1739376514/paperbg_q6qqe1.jpg")] h-screen overflow-y-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] overflow-x-hidden w-full'>
        ...
        <div className={`${loading||loader?'':'hidden'} w-screen flex items-center justify-center z-[999] h-screen fixed bg-[#352217] `}>
          ...
          <div className=' landing-banner relative overflow-hidden max-md:h-[100%] h-[190%]'>
                  ...
                  <img className='absolute h-full w-full object-cover z-1 ' src={`https://res.cloudinary.com/decks92gf/video/upload/v1740898752/5283818-uhd_4096_2160_24fps_xsl1nh.mp4`} >
                  </img>
          ...
          <ParallaxLayer speed={0.5} offset={0.99} className=' md:h-[900px] md:bg-[#00000042]  border-t-2 border-t-[#0000003b] md:backdrop-blur-md rounded-t-3xl'>
          ...
          <ParallaxLayer speed={1} offset={1.2}>
       ...
       <div className=' md:hidden bg-[#9f9279] bg-cover bg-center bg-[url("https://res.cloudinary.com/decks92gf/image/upload/v1739376514/paperbg_q6qqe1.jpg")] h-screen overflow-y-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] overflow-x-hidden w-full'>
