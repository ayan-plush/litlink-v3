...
const Landing=()=> {
  return (
    <div className='pt-[5vh] '>
      ...
      <img src='https://litlink-frontend.onrender.com/images/JOINUS.png' className='h-[9.75vh] border-b-[0.1vh] border-b-[#47362D] w-[28.5vh]'/>
      </Link>
      ...
      <div className=' flex justify-center'>
        <img src='https://litlink-frontend.onrender.com/images/theeye1.png' className='h-[40vh] w-[40vh]'/>
      </div> 
    </div>
  )
}
